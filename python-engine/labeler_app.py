"""
labeler_app.py — TrOCR Dataset Labeling Tool
Jalankan: python labeler_app.py
...
def get_paddle():
    global _paddle
    if _paddle is None:
        from paddleocr import PaddleOCRp

app = Flask(__name__)

BASE_DIR   = Path(__file__).resolve().parent
RAW_DIR    = BASE_DIR / "Dataset" / "raw_crops"
SAMPAH_DIR = BASE_DIR / "Dataset" / "sampah"
CSV_PATH   = BASE_DIR / "Dataset" / "labels.csv"
PROG_PATH  = BASE_DIR / "Dataset" / "labeler_progress.json"
...
<head>
<meta charset="UTF-8">
<title>TrOCR Labeling Tool</title>
<style>
...
if __name__ == "__main__":
    ...
    print(f"  Akses        : http://localhost:5001")
    print("=" * 52)
    print()
